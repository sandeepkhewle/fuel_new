...
app.use('/.well-known/acme-challenge/DgXnzrzb8IjzOu46UmP8GFLI6p_WSKVbfbBRwJR4AbQ', (req, res) => {
    try {
        res.send("DgXnzrzb8IjzOu46UmP8GFLI6p_WSKVbfbBRwJR4AbQ.SlFxx5G2l2gxWmrU5Nv0Oq6vqJZdXuh-G7ccKHaWd8Q")
    } catch (error) {
