...
DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashboardComponent, selectors: [["trends-dashboard"]], decls: 3, vars: 2, consts: [[4, "ngIf"], [1, "row", "pl-0", "pr-0", "ml-0", "mr-0"], [4, "ngFor", "ngForOf"], [1, "fyt-spinner-container"], [1, "text-center", "fyt-loading-msg"], [1, "col-md-6", "px-2"], [1, "row", "py-3", "pl-0", "pr-0", 3, "ngClass"], [1, "col-md-12", "px-3", "py-2"], [1, "new-Montserrat-Medium", "fnt-15", "new-ffffff"], ["class", "col-md-12", 4, "ngFor", "ngForOf"], [1, "col-md-12"], [1, "fyt-link-btn", "pl-0", "pr-0", "ml-0", "mr-0", "pb-0", "pt-0", "mb-0", "mt-10", "mb-10", "mat-card-shadow", "new-Montserrat-Medium", "fnt-15", "new-ffffff", 2, "height", "40px", 3, "ngClass"], [1, "fl", "pl-5", "pt-10"], [1, "fr", "pr-2", "pt-2"]], template: function DashboardComponent_Template(rf, ctx) { if (rf & 1) {
